...
public class CalculationsTest {
    ...
    public void simpleArithmeticsTest() {
        ...
        assertEquals(result_2, Calculations.getAnswer(equasion_2));
        assertEquals(result_3, Calculations.getAnswer(equasion_3));
        assertEquals(result_4, Calculations.getAnswer(equasion_4));
        assertEquals(result_5, Calculations.getAnswer(equasion_5));
        assertEquals(result_6, Calculations.getAnswer(equasion_6));
    }
